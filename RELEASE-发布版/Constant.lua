...
#                           __/ |
#                          |___/
    LUA COC7th 常量  by 雨鸣于舟 20210606
    改自溯洄、仑质所完成 Dice! QQ Dice Robot for TRPG
...
Constant.WeaponCOC7 = {
	...
	{"鲁格P08", "1D10","手枪"},
	{".41左轮手枪", "1D10","手枪"},
	{".44马格南左轮", "1D10+1D4+2","手枪"},
	{".45左轮手枪", "1D10+2","手枪"},
	{".45自动手枪", "1D10+2","手枪"},
	{"沙漠之鹰", "1D10+1D6+3","手枪"},
	{".58春田步枪", "1D10+4","步枪/霰弹枪"},
	{"5.6mm栓式枪机步枪", "1D6+1","步枪/霰弹枪"},
	{"7.62mm杠杆式枪机步枪", "2D6","步枪/霰弹枪"},
	{".45马提尼-亨利步枪", "1D8+1D6+3","步枪/霰弹枪"},
	{"莫兰上校的气动步枪", "2D6+1","步枪/霰弹枪"},
	{"加兰德步枪", "2D6+4","步枪/霰弹枪"},
	{"SKS半自动步枪", "2D6+1","步枪/霰弹枪"},
	{"56半自动步枪", "2D6+1","步枪/霰弹枪"},
	{"李-恩菲尔德", "2D6+4","步枪/霰弹枪"},
	{"7.62mm栓式枪机步枪", "2D6+4","步枪/霰弹枪"},
	{"7.62mm半自动步枪", "2D6+4","步枪/霰弹枪"},
	{".444马林步枪", "2D8+4","步枪/霰弹枪"},
	{"猎象枪", "3D6+4","步枪/霰弹枪"},
	{"20号霰弹枪", "2D6","步枪/霰弹枪"},
	{"16号霰弹枪", "2D6+2","步枪/霰弹枪"},
	{"12号霰弹枪", "4D6","步枪/霰弹枪"},
...
function Constant.RollTempInsanity()
	local status = calculate.Random(1,10)
	local text = "{nick}疯狂发作-临时症状：\n1D10="..status.."\n"..Constant.TempInsanity[status]
	local temp = calculate.Random(1,10)
	local addTxt = "1D10="..tostring(temp)
	text = string.gsub(text,"{0}",addTxt)
	if status == 9 then
		temp = calculate.Random(1,100)
...
function Constant.RollLongInsanity()
	local status = calculate.Random(1,10)
	local text = "{nick}疯狂发作-总结症状：\n1D10="..status.."\n"..Constant.LongInsanity[status]
	local temp = calculate.Random(1,10)
	local addTxt = "1D10="..tostring(temp)
	text = string.gsub(text,"{0}",addTxt)
	if status == 9 then
...
-- print(Constant.RollLongInsanity())
